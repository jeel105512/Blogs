...
export const show = async (req, res, next) => {
  try {
    const application = await findAndVarifyApplication(req);
...
export const update = async (req, res, next) => {
  try {
    ...
    req.session.notifications = [
      {
        alertType: "alert-danger",
        message: "Application failed to updated",
      },
    ];
    next(error);
  }
...
export const requestToken = async (req, res, _) => {
...
async function findAndVarifyApplication(req) {
